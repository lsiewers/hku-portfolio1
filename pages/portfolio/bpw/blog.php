...
Verder heb ik onderzoek gedaan naar de nodige tutorials en 1 zeer relevante gevonden voor een FPS shooter, gemaakt door Brackeys: <a target="_blank" href="http://devassets.com/assets/multiplayer-fps-assets/">tutorial</a>
      ...
      '3' => array (
        'layout' => 'left',
        'img' => 'onepage.png',
        'imgcaption' => 'One page design',
        'story' =>
        '<i>Di. 19 Februari</i><br><br>
          Het concept en onderzoek omgezet tot een one page design.
          Bekijk in volledige grootte: <a target="_blank" href="dist/img/portfolio/bpw/blog/onepage.png">One page design (png)</a>
        '
      )
    )
  );
